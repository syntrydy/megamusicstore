...
@Controller
public class MediaUploader extends ControllerUtils {
	private final StorageService storageService;
	private final MusicService musicService;
	private static final String REDIRECT_FILES = "redirect:/music";
	...
	@Autowired
	public MediaUploader(StorageService storageService, MusicService musicService) {
	...
	@PostMapping(PATH_MUSICFILE)
	public String handleFileUpload(@RequestParam(AttributeName.FILE) MultipartFile file,
			@RequestParam(AttributeName.ID) Long id, RedirectAttributes redirectAttributes) {
